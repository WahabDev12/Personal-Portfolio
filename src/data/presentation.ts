...
const presentation: Presentation = {
  ...
  description:
    "Hi there, I'm Abdul Wahab, a *fullstack developer* and *Linux nerd 🐧*. I'm currently a Computer Science major at Ashesi University. I love *building cool stuff* and exploring *low-level languages*. Outside coding, I like to play video games and football ⚽ .",
  socials: [
    {
      label: "Twitter",
  ...
  stacks:[
     ...
     {
        label: "TypeScript",
        link: "https://img.icons8.com/fluency/35/typescript--v2.png"
     },
     {
        label: "Python",
